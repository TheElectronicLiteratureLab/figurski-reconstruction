...
$(document).ready(function () {
    ...
    $(".modal-right-close").click(function () {
        ...
        $("#acid-map").fadeOut(10);
        $("#find-map").fadeOut(10);
        $("#shower-map").fadeOut(10);
        $("#holodeck-map").fadeOut(10);
        $("#oneone-map").fadeOut(10);
        $("#onetwo-map").fadeOut(10);
        $("#onethree-map").fadeOut(10);
        $("#twoone-map").fadeOut(10);
        $("#twotwo-map").fadeOut(10);
        $("#twothree-map").fadeOut(10);
        $("#threeone-map").fadeOut(10);
        $("#threetwo-map").fadeOut(10);
        $("#threethree-map").fadeOut(10);
        $("#doorway-open").fadeOut(10);
        $("#hallucination-open").fadeOut(10);
        $("#freedom-open").fadeOut(10);
        $("#piglove-open").fadeOut(10);
        $("#automaton-open").fadeOut(10);
        $("#meat-open").fadeOut(10);
        $("#devil-open").fadeOut(10);
        $("#digestion-open").fadeOut(10);
        $("#time-end").fadeOut(10);
        $("#navigator").css("display", "none");
        $(".lexia-map-open").css("display", "block");
        $("#notes-map-1").css("display", "block");
        $("#character-map-1").css("display", "block");
        $("#places-map-1").css("display", "block");
        $("#artifacts-map-1").css("display", "block");
        $("#oneex-map-open").css("display", "block");
        $("#twoex-map-open").css("display", "block");
        $("#threeex-map-open").css("display", "block");
    ...
    $("#open-hallucination").on("click", function (e) {
        $("#notes-map").fadeOut(10);
